            ...
            <div className="w-full ">
                <div className=" text-center flex flex-row justify-center ssw:gap-4">
                    {icons.map((icon, index) => (
                        <>
                            <div key={index} className='flex flex-row items-center gap-4 max-sw:hidden'>
                                <div
                            ...
                            <div key={index} className='flex flex-row items-center gap-4 max-lsw:hidden min-sw:hidden'>
                                <div
                            ...
                            <div key={index} className='flex flex-row items-center gap-4 max-ssw:hidden min-lsw:hidden'>
                                <div
                            ...
                            <div key={index} className='hidden max-ssw:flex flex-col items-center gap-4 max-w-[150px] mx-auto '>
                                <div
