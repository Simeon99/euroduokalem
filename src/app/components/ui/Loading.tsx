...
const Loading = () => {
    return (
        <div
            className="relative w-full h-[600px] bg-gray-300 animate-pulse rounded-2xl">
            {/* <div
            ...
            <div className='absolute w-full h-[290px] bottom-0 rounded-b-2xl bg-white'>
            ...
            <div className="absolute w-full h-[60px] bottom-0 bg-gray-300 rounded-b-2xl">
            </div>
        </div>
    )
}
